...
(def si
  (.newSignedInfo fac
    (.newCanonicalizationMethod fac CanonicalizationMethod/INCLUSIVE_WITH_COMMENTS nil)
...
(def dbf (doto (DocumentBuilderFactory/newInstance) (.setNamespaceAware true)))
...
(def dsc (new DOMSignContext (.getPrivate kp) (.getDocumentElement docu)))
